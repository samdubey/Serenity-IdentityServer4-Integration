namespace SerenityIdentityServerIntegration
{
    ...
    public static class DataMigrations
    {
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want SerenityIdentityServerIntegration migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "SerenityIdentityServerIntegration.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
